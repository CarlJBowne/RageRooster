...
public static class _Vec3Helper
{
    ...
    public static Vector2Z Rotate(this Vector2Z v, float amount)
        => Quaternion.AngleAxis(amount, Vector3.up) * v;
...
{
    public Vector2Z(float x = default, float z = default)
    {
        this.x = x;
        this.z = z;
    }
    ...
    public static Vector2Z forward = new(0, 1);
    public static Vector2Z back = new(0, -1);
    public static Vector2Z right = new(1, 0);
    public static Vector2Z left = new(-1, 0);

    public static implicit operator Vector2Z(Vector3 i) => new(i.x, i.z);
    public static implicit operator Vector3(Vector2Z i) => new(i.x, 0, i.z);
    public static implicit operator Vector2Z(Vector2 i) => new(i.x, i.y);
}