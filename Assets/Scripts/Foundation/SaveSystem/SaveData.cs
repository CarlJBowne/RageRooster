...
namespace RageRooster.Systems.SaveSystem
{
    ...
    public class SaveData
    {
        ...
        public static SaveData Clone(SaveData source, SaveData target)
        {
            ...
            source.playerStats.upgrades.Clone(target.playerStats.upgrades);
        ...
        /// </summary>
        public class IOStream : Utilities.JSON.JsonSaveStream<SaveData>
        {
            public IOStream(int fileID) : base(fileID) { }
            public override void InitFiles()
            {
                saveRootPath = $"{saveRootPath}/Save{fileID}";
            ...
            protected override JsonFile.LoadResult ReadToData(JObject RootFileData, SaveData ResultingData)
            {
            ...
            protected override JsonFile.FileState WriteFromData(SaveData sourceData)
            {
                ...
                PlayerFile.Data = new JObject
                {
                    ...
                    [nameof(sourceData.location)] = (JToken)(DestinationBasic)sourceData.location,
