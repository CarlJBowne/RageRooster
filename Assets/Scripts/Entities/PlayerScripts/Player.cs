...
public class Player : MonoBehaviour
{
    ...
    /// <summary>
    /// Begins the <see cref="Player"/> death sequence, also used for falling down pits which merely results in 1 lost health and a respawn.<br/>
    /// </summary>
    /// <param name="justPit">If it is just a pit.</param>
