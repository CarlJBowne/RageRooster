...
public class PlayerGroundedMovement_Old : PlayerMovementEffector
{
    [Header("Horizontal")]
    ...
    public PlayerGroundedMovement_Old rollState;
    public PlayerGroundedMovement_Old walkState;
    public PlayerGroundedMovement_Old prevPhase;
    [ShowField(nameof(__hasPrevPhase))] public float prevPhaseThreshold;
    public PlayerGroundedMovement_Old nextPhase;
