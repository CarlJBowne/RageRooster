...
public class ObjectPool : MonoBehaviour
{
    ...
    [Obsolete]
    public static ObjectPool Create(GameObject @object, GameObject prefabObject, int defaultPoolDepth, 
        bool canGrow = true, Transform parent = null, float autoDisableTime = -1, bool deleteObjectsOnDestroy = true)
    {
