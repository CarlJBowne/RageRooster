...
public class PlayerMBInheriting : CharacterMovementBody, ISingleton<PlayerMBInheriting>
{
    #region Config
    ...
    protected static PlayerMBInheriting Instance;
    protected ISingleton<PlayerMBInheriting> Interface => this;
    public static PlayerMBInheriting Get() => ISingleton<PlayerMBInheriting>.Get(ref Instance);
    public static bool TryGet(out PlayerMBInheriting result) => ISingleton<PlayerMBInheriting>.TryGet(Get, out result);
